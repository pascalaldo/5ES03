...
namespace HighRoller
{
    ...
    public class ArcBallCamera
    {
        ...
        private void ReCreateViewMatrix()
        {
            ...
            up = Vector3.Transform(new Vector3(0, 0, 1), Matrix.CreateFromYawPitchRoll(yaw, pitch, 0));

            //Convert the relative position to the absolute position
            position *= zoom;
            position += lookAt;
            //System.Diagnostics.Debug.WriteLine("Position arcball: " + position);
            //System.Diagnostics.Debug.WriteLine("lookAt arcball: " + lookAt);
            //System.Diagnostics.Debug.WriteLine("yaw arcball: " + yaw);
            //System.Diagnostics.Debug.WriteLine("Zoom arcball: " + Zoom);
        ...
        public float MinPitch = -MathHelper.Pi / 6.0f + 0.3f;
        public float MaxPitch = MathHelper.Pi / 6.0f - 0.3f;
        private float pitch;
        public float Pitch
        {
            get { return pitch; }
